...
export default async function LargePlateExtrasPage() {
  ...
  const { data: largePlateExtras, error } = await supabase
  ...
  return (
    <main className="mx-auto max-w-2xl px-6 py-8">
      <div className="mb-6 flex items-center justify-between">
        <h1 className="text-lg font-semibold">大板加算マスタ</h1>
        <Link
          href="/masters/large-plate-extras/new"
          ...
          {largePlateExtras?.map((extra) => (
            ...
            >
              ...
              <td className="py-2 pr-4">
                <Link
                  href={`/masters/large-plate-extras/${extra.id}`}
